...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const navItems = [
    { label: "Trang chủ", path: "/Sic_Bo/home" },
    { label: "Về chúng tôi", path: "/Sic_Bo/about" },
    { label: "Dự án", path: "/Sic_Bo/project" },
    { label: "Tiến độ", path: "/Sic_Bo/timeline" },
    { label: "Thỏa thuận dự án", path: "/Sic_Bo/project-agreement" },
  ]
      ...
      <div className="bg-white overflow-hidden w-full max-w-[1440px] min-h-screen relative flex flex-col">
        ...
        <footer className="bg-gray-900 text-white py-12 px-4 md:px-[148px]">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <img src="/Sic_Bo/UIT.png" alt="UIT Logo" className="h-15 w-65 mr-3" />
